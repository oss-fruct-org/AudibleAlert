...
public class TestOverlay extends RelativeLayout  {
	...
	private EnumMap<RelativeDirection, DirectionsPanel> panels = new EnumMap<RelativeDirection, DirectionsPanel>(
	...
	public void setDirections(List<Direction> directions, final float bearing) {
		for (Entry<RelativeDirection, DirectionsPanel> entry : panels.entrySet()) {
