...
public class TrackingService extends Service implements DistanceTracker.Listener, LocationReceiver.Listener, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private void updateDistanceTracker() {
		...
		distanceTracker.setRadius(pref.getInt(SettingsActivity.ALERT_RADIUS, 50));
	...
	public void pointInRange(PointDesc point) {
		...
		if (isTrackingMode) {
            Uri uri = Uri.EMPTY;
			audioPlayer.startAudioTrack(uri);
		}
...
/*
	...
	public static PointDesc getPointFromIntent(Intent intent) {
	...
	public void newLocation(Location location) {
		...
		//DefaultTrackManager.getInstance().updateLoadRadius(pref.getInt(SettingsActivity.GETS_RADIUS, 1000));
	}
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
		if (s.equals(SettingsActivity.ALERT_RADIUS)) {
		...
		} else if (s.equals(SettingsActivity.GETS_RADIUS)) {
